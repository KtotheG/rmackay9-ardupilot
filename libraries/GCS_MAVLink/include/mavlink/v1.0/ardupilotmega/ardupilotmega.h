...
typedef enum MAV_CMD
{
	...
	MAV_CMD_DO_DIGICAM_CONFIGURE=202, /* Mission command to configure an on-board camera controller system. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
